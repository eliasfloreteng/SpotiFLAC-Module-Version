...
from .post_processing import PostProcessingService, apply_post_processing
from .download_worker import ApplicationDownloadWorker
...
async def _transcode_result_async(
    ...
    from .post_processing import _transcode_result
...
async def _write_lrc_sidecars_async(
    ...
    from .post_processing import _write_lrc_sidecars
...
async def _write_canvas_sidecars_async(
    ...
    from .post_processing import _write_canvas_sidecars
...
class LegacyDownloadWorker:
    ...
    async def _run_downloads_application_async(
        ...
        self._post_processing = PostProcessingService(
            apply_post_processing, hooks=[run_hook]
        )
